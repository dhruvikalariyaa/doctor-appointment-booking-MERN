    ...
    return profileData && (
        <div>
            <div className='flex flex-col gap-4 m-5'>
                <div>
                    <img className=' w-full sm:max-w-64 rounded-lg bg-[#F5EFFF]' src={profileData.image} alt="" />
                </div>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <p className='flex items-center gap-2 text-3xl font-medium text-gray-700 text-[#7E60BF]'>{profileData.name}</p>
                    ...
                    {
                        isEdit
                            ? <button onClick={updateProfile} className='px-4 py-1 border border-bg-[#7E60BF] text-sm rounded-full mt-5 hover:bg-[#7E60BF] hover:text-white transition-all'>Save</button>
                            : <button onClick={() => setIsEdit(prev => !prev)} className='px-4 py-1 border border-bg-[#7E60BF] text-sm rounded-full mt-5 hover:bg-[#7E60BF] hover:text-white transition-all'>Edit</button>
                    }
